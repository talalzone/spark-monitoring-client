...
import org.apache.spark.monitoring.client.util.RestUtils;
...
public class SparkClient {
    ...
    public static final String DEFAULT_HISTORY_SERVER_URL = "http://127.0.0.1:18080/api/v1/";
    public static final String DEFAULT_MONTORING_SERVER_URL = "http://127.0.0.1:4040/api/v1/";
    ...
    public Optional<Job> getJob(String appId, Integer jobId) {
    ...
    public static SparkClient createHistoryClient() {
        return new Builder()
                .setBaseUrl(DEFAULT_HISTORY_SERVER_URL)
                .addConverterFactory(MoshiConverterFactory.create())
                .get();
    }

    public static SparkClient createMonitoringClient() {
        return new Builder()
                .setBaseUrl(DEFAULT_MONTORING_SERVER_URL)
                .addConverterFactory(MoshiConverterFactory.create())
                .get();
    }
